...
public class GreedyActivity extends AppCompatActivity implements View.OnClickListener{
    String name;
    String table;
    TextView result;
    Button button;
    ListView listView;
    private ImageView dtgh,main,huisu,gene,paint,back;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.im_huisu:
                Intent intentt = new Intent(GreedyActivity.this,BacktrackingActivity.class);
    ...
    private void writeExcel() {
        ...
        excelFilePath = getExternalStoragePath() + "/ExportExcel/贪心法解决0-1背包问题.xls";
